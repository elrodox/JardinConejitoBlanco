...
class Noticia extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('titulo, descripcion, importante, fecha', 'required'),
			array('importante', 'numerical', 'integerOnly'=>true),
			array('titulo', 'length', 'max'=>100),
			array('descripcion', 'length', 'max'=>500),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_noticia, titulo, descripcion, importante, fecha', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('importante',$this->importante);
